class Recipe {
  ...
  listIngredients() {
    ...
    const ingredientNames = ingredientDataObjs.map((ingredient) => {
      return this.listOfRecipeIngredients.push({
  ...
  listIngredientsNames() {
    ...
    const ingredientNames = ingredientDataObjs.map(
  ...
  costOfIngredients() {
    const ingredientAmount = this.ingredients.map(
    ...
    const ingredientCost = ingredientDataObjs.map(
