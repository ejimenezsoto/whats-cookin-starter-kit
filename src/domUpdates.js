...
const domUpdates = {
    displayRecipes(singleRecipeSection, favoriteRecipeSection, allRecipesSection, cookBook) {
    ...
    showFavoriteRecipes(favoriteRecipeSection, allRecipesSection, singleRecipeSection, currentUser, filter, pageTitle) {
  ...
  return displayFavoriteRecipes
    ...
    populateSearch(e, filter, cookBook, allRecipesSection, favoriteRecipeSection) {
  ...
  mealsToCookSingleRecipe(event, singleRecipeSection, favoriteRecipeSection, allRecipesSection, mealsToCookSection, currentRecipe, currentUser) {
  singleRecipeSection.innerHTML = ''
  if (event.target.id) {
    hide(favoriteRecipeSection)
    hide(allRecipesSection)
  ...
  showMealPlan(pageTitle, mealsToCookSection, allRecipesSection, pantrySection, favoriteRecipeSection, searchBox, filter, currentUser, singleRecipeSection) {
