...
describe('Cookbook', () => {
  ...
  it('should filter by the tags and return a recipe', () => {
    expect(cookbook.filterByTags('breakfast')).to.deep.equal([
      {
      "id": 678353,
  ...
  it('should filter by another tag', () => {
    const cookbook2 = new Cookbook(recipes)
    expect(cookbook2.filterByTags('dinner')).to.deep.equal([
      {
      "id": 412309,
  ...
  it('should filter by name', () => {
    expect(cookbook.filterByKeyWord("Loaded Chocolate Chip Pudding Cookie Cups")).to.deep.equal([{ "id": 595736,
  ...
  it('should filter by ingredients', () => {
    expect(cookbook.filterByKeyWord('egg')).to.deep.equal(
    [{
    "id": 595736,
    "image": "https://spoonacular.com/recipeImages/595736-556x370.jpg",
    "ingredients": [
